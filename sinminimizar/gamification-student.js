...
(function () {
    ...
    const checkboxAlumno = document.getElementsByClassName("custom-control-input");
    ...
    let onLanguageLoaded = function (err, i18n) {
        ...
        checkboxAlumno.addEventListener('click', function() {
            //Funcion al seleccionar el checkbox de la pregunta
            console.log("hola");
    ...
    $(document).ready(function () {
        ...
        fetch(`${scriptPath}/../assets/generator/content/v4-6-0/languages/${currLang}.json`)
